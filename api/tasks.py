...
class Tasks(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.project_id = TodoBase().get_all_projects()["body"][0]["id"]
        cls.section_id = TodoBase().get_all_sections()["body"][0]["id"]
        cls.task_id = TodoBase().get_all_tasks()["body"][0]["id"]
    ...
    def test_update_task(self):
        ...
        response = RestClient().send_request("post", session=self, headers=HEADERS,
    ...
    def test_delete_task(self):
        ...
        response = RestClient().send_request("delete", session=self, headers=HEADERS,
                                             url=url_task_delete, data=None)
